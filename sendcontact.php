...
define( "RECIPIENT_NAME", "Eric Gaynor" ); //UPDATE THIS TO YOUR NAME
define( "RECIPIENT_EMAIL", "eag2178@columbia.edu" ); //UPDATE THIS TO YOUR EMAIL ID
define( "EMAIL_SUBJECT", "Online Portfolio Conact Form" ); //UPDATE THIS TO YOUR SUBJECT
